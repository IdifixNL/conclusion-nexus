...
# Clean Deployment Script for Conclusion Nexus
# This script properly stops all containers and cleans up before deploying

DOMAIN="conclusion-nexus.baburek.eu"
EMAIL="nico_baburek@hotmail.com"

echo "🧹 Starting clean deployment for $DOMAIN..."
...
# Stop any processes using ports 3000 and 3001
echo "🔌 Killing processes using ports 3000 and 3001..."
